    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"ʏᴏᴜʀ ᴛᴏᴋᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ᴀɴᴅ ᴠᴀʟɪᴅ ғᴏʀ: 6 ʜᴏᴜʀ", reply_markup=reply_markup, protect_content=False, quote=True)
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                TUT_VID = f"https://t.me/COSMIC_ANIME_CHAT/10571"
